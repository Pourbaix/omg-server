...
exports.detectEventInRange = function (req, res) {
	...
	let pendingTagsFromFunction = getPendingTags(req, res).then(() =>
		console.log("ok synchronisé")
	);
							...
							data.forEach((res, i) => {
								...
								if (time >= from && time <= to) {
									...
									if (
										...
										const datetime =
											roundTo5MinutesAndAddSummerTime(
